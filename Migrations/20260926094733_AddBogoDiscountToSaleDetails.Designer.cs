...
namespace CarePlusPharmacy.Migrations
{
    ...
    [Migration("20260926094733_AddBogoDiscountToSaleDetails")]
    partial class AddBogoDiscountToSaleDetails
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarePlusPharmacy.Models.CustomerMembership", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CarePlusPharmacy.Models.MembershipTier", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("HasDedicatedPharmacist")
                        .HasColumnType("tinyint(1)");

                    b.Property<bool>("IsActive")
                        .HasColumnType("tinyint(1)");

                    b.Property<int>("MaxFamilyAccounts")
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("PriorityDispensing")
                        .HasColumnType("tinyint(1)");
            ...
            modelBuilder.Entity("CarePlusPharmacy.Models.Sale", b =>
                {
                    ...
                    b.Property<string>("AppliedDiscountSource")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("varchar(100)");
            ...
            modelBuilder.Entity("CarePlusPharmacy.Models.SaleDetail", b =>
                {
                    ...
                    b.Property<decimal>("BogoDiscountAmount")
                        .HasColumnType("decimal(10,2)");
            ...
            modelBuilder.Entity("CarePlusPharmacy.Models.CustomerMembership", b =>
                {
                    ...
                    b.HasOne("CarePlusPharmacy.Models.MembershipTier", "MembershipTier")
                        .WithMany("Memberships")
            ...
            modelBuilder.Entity("CarePlusPharmacy.Models.CustomerSubscription", b =>
                {
                    ...
                    b.HasOne("CarePlusPharmacy.Models.Branch", "Branch")
                        .WithMany()
            ...
            modelBuilder.Entity("CarePlusPharmacy.Models.Sale", b =>
                {
                    ...
                    b.HasOne("CarePlusPharmacy.Models.ApplicationUser", "VoidedBy")
                        .WithMany()
